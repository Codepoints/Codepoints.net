...
<main class="main main--about">
  ...
  <h1><?=_q('Finding Characters')?></h1>
    ...
    “%s”'), '<kbd><a href="'.url('U+0200..U+0300').'">codepoints.net/U+0200..U+0300</a></kbd>')?>.</p>
  </section>
  <section id="unicode">
...
<?php printf(__('Unicode is a mechanism for universally identifying characters. All
  ...
  <section id="this_site">
    ...
    <figure class="other">
      <picture>
        <source srcset="<?=static_url('src/images/were_open.webp')?>" type="image/webp">
        <img src="<?=static_url('src/images/were_open.jpg')?>" alt="<?=_q('a sign in the style of an old wood board reading “Come in. We’re Open Source.”')?>"
  ...
  <section id="attribution">
    ...
    <figure class="other">
      <a href="https://uberspace.de" rel="external"><img src="<?=static_url('src/images/uberspace.png')?>" alt="Hosted on Asteroids" width="150" height="80"></a>
    </figure>
