...
printf(
  ...
  <dl id="glossary">
    ...
    <dd>Characters with the Alphabetic property. For more information, see <i>Chapter 4, Character Properties</i> in [<a href="http://unicode.org/reports/tr41/tr41-9.html#Unicode">Unicode</a>].
      <p><i>Generated from: Lu + Ll + Lt + Lm + Lo + Nl + <a href="#OAlpha">Other Alphabetic</a></i></p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="AHex">ASCII Hex Digit</dt>
    <dd>ASCII characters commonly used for the representation of hexadecimal numbers. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    <dd>Mapping from characters to their case-folded forms. This is an informative file containing normative derived properties.
      ...
      <p><b>Note: </b>The case foldings are omitted in the data file if they are the same as the code point itself.</p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    <dd>Characters which are ignored for casing purposes. For more information, see D136 in <i>Section 3.13, Default Case Algorithms</i> in [<a href="http://unicode.org/reports/tr41/tr41-9.html#Unicode">Unicode</a>].
      <p><i>Generated from: Mn + Me + Cf + Lm + Sk + <a href="#WB">Word Break</a>=MidLetter + <a href="#WB">Word Break</a>=MidNumLet</i></p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    <dd>Characters which are considered to be either uppercase, lowercase or titlecase characters. This property is not identical to the Changes_When_Casemapped property. For more information, see D135 in <i>Section 3.13, Default Case Algorithms</i> in [<a href="http://unicode.org/reports/tr41/tr41-9.html#Unicode">Unicode</a>].
      <p><i>Generated from: <a href="#Lower">Lowercase</a> + <a href="#Upper">Uppercase</a> + Lt</i></p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    <dd>Characters whose normalized forms are not stable under case folding. For more information, see D142 in <i>Section 3.13, Default Case Algorithms</i> in [<a href="http://unicode.org/reports/tr41/tr41-9.html#Unicode">Unicode</a>].
      <p><i>Generated from: toCasefold(toNFD(X)) != toNFD(X)</i></p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    <dd>Characters which may change when they undergo case mapping. For more information, see D143 in <i>Section 3.13, Default Case Algorithms</i> in [<a href="http://unicode.org/reports/tr41/tr41-9.html#Unicode">Unicode</a>].
      <p><i>Generated from: Changes_When_Lowercased(X) or Changes_When_Uppercased(X) or Changes_When_Titlecased(X)</i></p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    <dd>Characters whose normalized forms are not stable under a toTitlecase mapping. For more information, see D141 in <i>Section 3.13, Default Case Algorithms</i> in [<a href="http://unicode.org/reports/tr41/tr41-9.html#Unicode">Unicode</a>].
      <p><i>Generated from: toTitlecase(toNFD(X)) != toNFD(X)</i></p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    <dt id="Dash">Dash</dt>
    <dd>Punctuation characters explicitly called out as dashes in the Unicode Standard, plus their compatibility equivalents. Most of these have the General_Category value Pd, but some have the General_Category value Sm because of their use in mathematics. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="dt">Decomposition Type</dt>
    <dt id="dm">Decomposition Mapping</dt>
    <dd>This field contains both values, with the type in angle brackets. The decomposition mappings exactly match the decomposition mappings published with the character names in the Unicode Standard. For more information, see <a href="http://unicode.org/reports/tr44/#Character_Decomposition_Mappings">Character Decomposition Mappings</a>. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    <dd>For programmatic determination of default ignorable code points. New characters that should be ignored in rendering (unless explicitly supported) will be assigned in these ranges, permitting programs to correctly handle the default rendering of such characters when not otherwise supported. For more information, see the FAQ <a href="http://www.unicode.org/faq/unsup_char.html">Display of Unsupported Characters</a>, and <i>Section 5.21, Default Ignorable Code Points</i> in [<a href="http://unicode.org/reports/tr41/tr41-9.html#Unicode">Unicode</a>].
      <p><i>Generated from<br> <a href="#ODI">Other Default Ignorable Code Point</a><br>
        ...
        - 0600..0604, 06DD, 070F, 110BD (exceptional Cf characters that should be visible)</i></p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="Dep">Deprecated</dt>
    <dd>For a machine-readable list of deprecated characters. No characters will ever be removed from the standard, but the usage of deprecated characters is strongly discouraged. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="Dia">Diacritic</dt>
    <dd>Characters that linguistically modify the meaning of another character to which they apply. Some diacritics are not combining characters, and some combining characters are not diacritics. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="ea">East Asian Width</dt>
    <dd>Properties for determining the choice of wide versus narrow glyphs in East Asian contexts. Property values are described in Unicode Standard Annex #11, "East Asian Width" [<a href="http://unicode.org/reports/tr41/tr41-9.html#UAX11">UAX11</a>]. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    <dd>Characters that expand to more than one character in the specified normalization form. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="Ext">Extender</dt>
    <dd>Characters whose principal function is to extend the value or shape of a preceding alphabetic character. Typical of these are length and iteration marks. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    <dd>Characters that require extra mappings for closure under Case Folding plus Normalization Form KC.
      <p>The mapping is listed in Field 2.</p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    <dd>Formerly proposed for programmatic determination of grapheme cluster boundaries.
      <p><i>Generated from: Canonical_Combining_Class=Virama</i></p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="hst">Hangul Syllable Type</dt>
    <dd>The values L, V, T, LV, and LVT used in <i>Chapter 3, Conformance</i> in [<a href="http://unicode.org/reports/tr41/tr41-9.html#Unicode">Unicode</a>]. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="Hex">Hex Digit</dt>
    <dd>Characters commonly used for the representation of hexadecimal numbers, plus their compatibility equivalents. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="Hyphen">Hyphen (deprecated, stabilized)</dt>
    <dd>Dashes which are used to mark connections between pieces of words, plus the <i>Katakana middle dot</i>. The <i>Katakana middle dot</i> functions like a hyphen, but is shaped like a dot rather than a dash. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="IDS">ID Start</dt>
    <dt id="IDC">ID Continue</dt>
    <dt id="XIDS">XID Start</dt>
    <dt id="XIDC">XID Continue</dt>
    <dd>Used to determine programming identifiers, as described in Unicode Standard Annex #31, "Unicode Identifier and Pattern Syntax" [<a href="http://unicode.org/reports/tr41/tr41-9.html#UAX31">UAX31</a>]. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="Ideo">Ideographic</dt>
    <dd>Characters considered to be CJKV (Chinese, Japanese, Korean, and Vietnamese) ideographs. This property roughly defines the class of "Chinese characters" and does not include characters of other logographic scripts such as Cuneiform or Egyptian Hieroglyphs. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="IDSB">IDS Binary Operator</dt>
    <dd>Used in Ideographic Description Sequences. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="IDST">IDS Trinary Operator</dt>
    <dd>Used in Ideographic Description Sequences. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="InPC">Indic Positional Category</dt>
    <dd>A property defining the placement categories for dependent vowels, viramas, combining marks, and other characters used in Indic scripts. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="InSC">Indic Syllabic Category</dt>
    <dd>A property defining the structural categories of syllabic components in Indic scripts. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    <dd>ISO 10646 comment field. It was used for notes that appeared in parentheses in the 10646 names list, or contained an asterisk to mark an Annex P note.
      <p>As of Unicode 5.2.0, this field no longer contains any non-null values.</p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="Join_C">Join Control</dt>
    <dd>Format control characters which have specific functions for control of cursive joining and ligation. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="jt">Joining Type</dt>
    <dt id="jg">Joining Group</dt>
    <dd>Basic Arabic and Syriac character shaping properties, such as initial, medial and final shapes. See <i>Section 8.2, Arabic</i> in [<a href="http://unicode.org/reports/tr41/tr41-9.html#Unicode">Unicode</a>]. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="JSN">Jamo Short Name</dt>
    <dd>The Hangul Syllable names are derived from the Jamo Short Names, as described in <i>Chapter 3, Conformance</i> in [<a href="http://unicode.org/reports/tr41/tr41-9.html#Unicode">Unicode</a>]. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    The three numeric-value fields should have no overlap; that is, characters with a kAccountingNumeric value should not have a kPrimaryNumeric or kOtherNumeric value as well.<br> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kBigFive">kBigFive</dt>
    <dd>The Big Five mapping for this character in hex; note that this does not cover any of the Big Five extensions in common use, including the ETEN extensions. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kCangjie">kCangjie</dt>
    <dd>The cangjie input code for the character. This incorporates data from the file cangjie-table.b5 by Christian Wittern. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    The position is indicated by a decimal number. The digits to the left of the decimal are the page number. The first digit after the decimal is the row on the page, and the remaining two digits after the decimal are the position on the row. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kCNS1986">kCNS1986</dt>
    <dd>The CNS 11643-1986 mapping for this character in hex. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kCNS1992">kCNS1992</dt>
    <dd>The CNS 11643-1992 mapping for this character in hex. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kCompatibilityVariant">kCompatibilityVariant</dt>
    <dd>The compatibility decomposition for this ideograph, derived from the UnicodeData.txt file. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    Approximately 100 characters from Cowles which are not currently encoded are being submitted to the IRG by Unicode for inclusion in future versions of the standard. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    The edition used is the first edition, published in Seoul by Samseong Publishing Co., Ltd., 1988. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    Major definitions are separated by semicolons, and minor definitions by commas. Any valid Unicode character (except for tab, double-quote, and any line break character) may be used within the definition field. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kEACC">kEACC</dt>
    <dd>The EACC mapping for this character in hex. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    Characters which have a frequency letter but no Soothill phonetic group are assigned group 0. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kFennIndex">kFennIndex</dt>
    <dd>The position of this character in _Fenn’s Chinese-English Pocket Dictionary_ by Courtenay H. Fenn, Cambridge, Mass.: Harvard University Press, 1942. The position is indicated by a three-digit page number followed by a period and a two-digit position on the page. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    Values in this field consist of four decimal digits, optionally followed by a period and fifth digit for a five-digit form. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kFrequency">kFrequency</dt>
    <dd>A rough frequency measurement for the character based on analysis of traditional Chinese USENET postings; characters with a kFrequency of 1 are the most common, those with a kFrequency of 2 are less common, and so on, through a kFrequency of 5. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kGB0">kGB0</dt>
    <dd>The GB 2312-80 mapping for this character in ku/ten form. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kGB1">kGB1</dt>
    <dd>The GB 12345-90 mapping for this character in ku/ten form. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kGB3">kGB3</dt>
    <dd>The GB 7589-87 mapping for this character in ku/ten form. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kGB5">kGB5</dt>
    <dd>The GB 7590-87 mapping for this character in ku/ten form. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kGB7">kGB7</dt>
    <dd>The GB 8565-89 mapping for this character in ku/ten form. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kGB8">kGB8</dt>
    <dd>The GB 8565-89 mapping for this character in ku/ten form. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kGradeLevel">kGradeLevel</dt>
    <dd>The primary grade in the Hong Kong school system by which a student is expected to know the character; this data is derived from 朗文初級中文詞典, Hong Kong: Longman, 2001. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kGSR">kGSR</dt>
    <dd>The position of this character in Bernhard Karlgren’s Grammata Serica Recensa (1957).<br><br>
    This dataset contains a total of 7,405 records. References are given in the form DDDDa('), where “DDDD” is a set number in the range [0001..1260] zero-padded to 4-digits, “a” is a letter in the range [a..z] (excluding “w”), optionally followed by apostrophe ('). The data from which this mapping table is extracted contains a total of 10,023 references. References to inscriptional forms have been omitted. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kHangul">kHangul</dt>
    <dd>The modern Korean pronunciation(s) for this character in Hangul. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    The first character assigned a given virtual position has an index ending in 1; the second assigned the same virtual position has an index ending in 2; and so on. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kHanyuPinlu">kHanyuPinlu</dt>
    <dd>The Pronunciations and Frequencies of this character, based in part on those appearing in 《現代漢語頻率詞典》 &lt;Xiandai Hanyu Pinlu Cidian&gt; (XDHYPLCD) [Modern Standard Beijing Chinese Frequency Dictionary]. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    The only value currently in this field is “2.1”, which is the identifier of the version of IICore used to populate this field. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    The edition used is the first edition, published in Seoul by Samseong Publishing Co., Ltd., 1988.<br> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    This field represents the official position of the character within the DaiKanwa dictionary as used by the IRG in the four-dictionary sorting algorithm. The edition used is the revised edition, published in Tokyo by Taishuukan Shoten, 1986. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    The edition of the Hanyu Da Zidian used is the first edition, published in Chengdu by Sichuan Cishu Publishing, 1986. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    Thus, “1187.060” indicates the sixth character on page 1187. A character not in this dictionary but assigned a position between the 6th and 7th characters on page 1187 for sorting purposes would have the code “1187.061”.<br><br>
    The edition of the Kang Xi Dictionary used is the 7th edition published by Zhonghua Bookstore in Beijing, 1989.<br> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    GZJW Yinzhou Jinwen Jicheng Yinde (殷周金文集成引得)<br> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kIRG_HSource">kIRG_HSource</dt>
    <dd>The IRG “H” source mapping for this character in hex. The IRG “H” source consists of data from the Hong Kong Supplementary Character Set – 2008. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    JARIB Association of Radio Industries and Businesses (ARIB) ARIB STD-B24 Version 5.1, March 14 2007 <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    KP0 KPS 9566-97<br>
    KP1 KPS 10721-2000 <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    Note that the K4 source is expressed in hexadecimal, but unlike the other sources, it is not organized in row/column. The content of the repertoire covered by the K2, K3, K4, and K5 sources is in the process of being reedited in new Korean standards.<br> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kIRG_MSource">kIRG_MSource</dt>
    <dd>The IRG “M” source mapping for this character. The IRG “M” source consists of data from the Macao Information System Character Set (澳門資訊系統字集). <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    TF TCA-CNS 11643-1992 15th plane <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kIRG_USource">kIRG_USource</dt>
    <dd>The IRG “U” source mapping for this character. U-source references are a reference into the U-source ideograph database; see UTR #45. These consist of “UTC” or “UCI” followed by a hyphen and a five-digit, zero-padded index into the database. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    V2 VHN 01:1998<br>
    V3 VHN 02: 1998<br>
    V4 Dictionary on Nom 2006, Dictionary on Nom of Tay ethnic 2006, Lookup Table for Nom in the South 1994 <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kJapaneseKun">kJapaneseKun</dt>
    <dd>The Japanese pronunciation(s) of this character. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kJapaneseOn">kJapaneseOn</dt>
    <dd>The Sino-Japanese pronunciation(s) of this character. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kJis0">kJis0</dt>
    <dd>The JIS X 0208-1990 mapping for this character in ku/ten form. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kJIS0213">kJIS0213</dt>
    <dd>The JIS X 0213-2000 mapping for this character in min/ku/ten form. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kJis1">kJis1</dt>
    <dd>The JIS X 0212-1990 mapping for this character in ku/ten form. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    If the index is followed by an asterisk (*), then the index is an interpolated one, indicating where the character would be found if it were to have been included in the dictionary. Note that while the index itself is usually an integer, there are some cases where it is an integer followed by an “A”. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kKorean">kKorean</dt>
    <dd>The Korean pronunciation(s) of this character, using the Yale romanization system. (See &lt;http://en.wikipedia.org/wiki/Korean_romanization&gt; for a discussion of the various Korean romanization systems.) <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kKPS0">kKPS0</dt>
    <dd>The KPS 9566-97 mapping for this character in hexadecimal form. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kKPS1">kKPS1</dt>
    <dd>The KPS 10721-2000 mapping for this character in hexadecimal form. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kKSC0">kKSC0</dt>
    <dd>The KS X 1001:1992 (KS C 5601-1989) mapping for this character in ku/ten form. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kKSC1">kKSC1</dt>
    <dd>The KS X 1002:1991 (KS C 5657-1991) mapping for this character in ku/ten form. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kLau">kLau</dt>
    ...
    The index consists of an integer. Missing indices indicate unencoded characters which are being submitted to the IRG for inclusion in future versions of the standard. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kMainlandTelegraph">kMainlandTelegraph</dt>
    <dd>The PRC telegraph code for this character, derived from “Kanzi denpou koudo henkan-hyou” (“Chinese character telegraph code conversion table”), Lin Jinyi, KDD Engineering and Consulting, Tokyo, 1984. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    <em>Multiple Value Order:</em> When there are two values, then the first is preferred for zh-Hans (CN) and the second is preferred for zh-Hant (TW). When there is only one value, it is appropriate for both. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    The edition used is the revised edition, published in Tokyo by Taishuukan Shoten, 1986. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kNelson">kNelson</dt>
    <dd>The index of this character in The Modern Reader’s Japanese-English Character Dictionary by Andrew Nathaniel Nelson, Rutland, Vermont: Charles E. Tuttle Company, 1974. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kOtherNumeric">kOtherNumeric</dt>
    <dd>The numeric value for the character in certain unusual, specialized contexts.<br><br>
    The three numeric-value fields should have no overlap; that is, characters with a kOtherNumeric value should not have a kAccountingNumeric or kPrimaryNumeric value as well.<br> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kPhonetic">kPhonetic</dt>
    <dd>The phonetic index for the character from _Ten Thousand Characters: An Analytic Dictionary_, by G. Hugh Casey, S.J. Hong Kong: Kelley and Walsh, 1980. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    The three numeric-value fields should have no overlap; that is, characters with a kPrimaryNumeric value should not have a kAccountingNumeric or kOtherNumeric value as well.<br> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kPseudoGB1">kPseudoGB1</dt>
    <dd>A “GB 12345-90” code point assigned to this character for the purposes of including it within Unihan. Pseudo-GB1 codes were used to provide official code points for characters not already in national standards, such as characters used to write Cantonese, and so on. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    <dd>One or more Japanese radical/stroke counts for this character in the form “radical.additional strokes”. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kRSKangXi">kRSKangXi</dt>
    <dd>One or more KangXi radical/stroke counts for this character consistent with the value of the kKangXi field in the form “radical.additional strokes”. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kRSKanWa">kRSKanWa</dt>
    <dd>One or more Morohashi radical/stroke counts for this character in the form “radical.additional strokes”. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kRSKorean">kRSKorean</dt>
    <dd>One or more Korean radical/stroke counts for this character in the form “radical.additional strokes”. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    The first value is equal to the normative radical-stroke value defined in ISO/IEC 10646. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    Much of the of the data on simplified and traditional variants was graciously supplied by Wenlin Institute, Inc. &lt;http://www.wenlin.com&gt;. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    A specialized semantic variant is an x- or y-variant with similar or identical meaning only in certain contexts (such as accountants’ numerals).<br> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kTaiwanTelegraph">kTaiwanTelegraph</dt>
    <dd>The Taiwanese telegraph code for this character, derived from “Kanzi denpou koudo henkan-hyou” (“Chinese character telegraph code conversion table”), Lin Jinyi, KDD Engineering and Consulting, Tokyo, 1984.<br> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kTang">kTang</dt>
    <dd>The Tang dynasty pronunciation(s) of this character, derived from or consistent with _T’ang Poetic Vocabulary_ by Hugh M. Stimson, Far Eastern Publications, Yale Univ. 1976. An asterisk indicates that the word or morpheme represented in toto or in part by the given character with the given reading occurs more than four times in the seven hundred poems covered. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    ...
    <dd>The character’s pronunciation(s) in Quốc ngữ. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kXerox">kXerox</dt>
    <dd>The Xerox code for this character. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kXHC1983">kXHC1983</dt>
    <dd>One or more Hànyǔ Pīnyīn readings as given in the Xiàndài Hànyǔ Cídiǎn.<br><br>
    Each pīnyīn reading is preceded by the character’s location(s) in the dictionary, separated from the reading by “:” (colon); multiple locations for a given reading are separated by “,” (comma); multiple “location: reading” values are separated by “ ” (space). Each location reference is of the form /[0-9]{4}\.[0-9]{3}\*?/ . The number preceding the period is the page number, zero-padded to four digits. The first two digits of the number following the period are the entry’s position on the page, zero-padded. The third digit is 0 for a main entry and greater than 0 for a parenthesized variant of the main entry. A trailing “*” (asterisk) on the location indicates an encoded variant substituted for an unencoded character (see below). <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="kZVariant">kZVariant</dt>
    <dd>The Unicode value(s) for known z-variants of this character.<br><br>
    The basic syntax is a Unicode scalar value. It may optionally be followed by additional data. The additional data is separated from the Unicode scalar value by a less-than sign (&lt;), and may be subdivided itself into substrings by commas. The additional data consists of a series of field tags for another field in the Unihan database indicating the source of the information. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr38/">UAX38</a>')?></small></dd>
    <dt id="lb">Line Break</dt>
    <dd>Properties for line breaking. For more information, see Unicode Standard Annex #14, "Unicode Line Breaking Algorithm" [<a href="http://unicode.org/reports/tr41/tr41-9.html#UAX14">UAX14</a>]. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="LOE">Logical Order Exception</dt>
    <dd>A small number of spacing vowel letters occurring in certain Southeast Asian scripts such as Thai and Lao, which use a visual order display model. These letters are stored in text ahead of syllable-initial consonants, and require special handling for processes such as searching and sorting. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="Lower">Lowercase</dt>
    <dd>Characters with the Lowercase property. For more information, see <i>Chapter 4, Character Properties</i> in [<a href="http://unicode.org/reports/tr41/tr41-9.html#Unicode">Unicode</a>].<p><i>Generated from: Ll + <a href="#OLower">Other Lowercase</a></i></p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="lc">Lowercase Mapping</dt>
    <dt id="tc">Titlecase Mapping</dt>
    <dt id="uc">Uppercase Mapping</dt>
    <dd>Data for producing (in combination with the simple case mappings from <a href="http://unicode.org/reports/tr44/#UnicodeData.txt">UnicodeData.txt</a>) the full case mappings. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="Math">Math</dt>
    <dd>Characters with the Math property. For more information, see <i>Chapter 4, Character Properties</i> in [<a href="http://unicode.org/reports/tr41/tr41-9.html#Unicode">Unicode</a>].<p><i>Generated from: Sm + <a href="#OMath">Other Math</a></i></p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="na">Name</dt>
    <dd>These names match exactly the names published in the code charts of the Unicode Standard. The derived Hangul Syllable names are omitted from this file; see <a href="http://unicode.org/reports/tr44/#Jamo.txt">Jamo.txt</a> for their derivation. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="alias">Name Alias</dt>
    <dd>Normative formal aliases for characters with erroneous names, for control characters and some format characters, and for character abbreviations, as described in <i>Chapter 4, Character Properties</i> in [<a href="http://unicode.org/reports/tr41/tr41-9.html#Unicode">Unicode</a>]. The aliases tagged with the type "correction" exactly match the formal aliases published in the Unicode Standard code charts. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    <dd>If the character has the property value Numeric_Type=Numeric, then the Numeric_Value of that character is represented with a positive or negative integer or rational number in this field, and fields 6 and 7 are null. This includes fractions such as, for example, "1/5" for U+2155 VULGAR FRACTION ONE FIFTH.
      <p>Some characters have these properties based on values from the Unihan data files. See <a href="#Numeric_Type_Han">Numeric Type Han</a>.</p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    <dd>The characters tagged with either kPrimaryNumeric, kAccountingNumeric, or kOtherNumeric are given the property value Numeric_Type=Numeric, and the Numeric_Value indicated in those tags.
      <p>Most characters have these numeric properties based on values from UnicodeData.txt. See <a href="#nt">Numeric_Type</a>.</p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="OAlpha">Other Alphabetic</dt>
    <dd>Used in deriving the Alphabetic property. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="ODI">Other Default Ignorable Code Point</dt>
    <dd>Used in deriving the Default_Ignorable_Code_Point property. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="OGr_Ext">Other Grapheme Extend</dt>
    <dd>Used in deriving&nbsp; the Grapheme_Extend property. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="OIDC">Other ID Continue</dt>
    <dd>Used to maintain backward compatibility of <a href="#IDC">ID Continue</a>. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="OIDS">Other ID Start</dt>
    <dd>Used to maintain backward compatibility of <a href="#IDS">ID Start</a>. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="OLower">Other Lowercase</dt>
    <dd>Used in deriving the Lowercase property. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="OMath">Other Math</dt>
    <dd>Used in deriving the Math property. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="OUpper">Other Uppercase</dt>
    <dd>Used in deriving the Uppercase property. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    ...
    <dd>Used in Ideographic Description Sequences. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="sc">Script</dt>
    <dd>Script values for use in regular expressions and elsewhere. For more information, see Unicode Standard Annex #24, "Unicode Script Property" [<a href="http://unicode.org/reports/tr41/tr41-9.html#UAX24">UAX24</a>]. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="scx">Script Extensions</dt>
    <dd>Enumerated sets of Script values for use in regular expressions and elsewhere. For more information, see Unicode Standard Annex #24, "Unicode Script Property" [<a href="http://unicode.org/reports/tr41/tr41-9.html#UAX24">UAX24</a>]. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="SB">Sentence Break</dt>
    <dd>See Unicode Standard Annex #29, "Unicode Text Segmentation" [<a href="http://unicode.org/reports/tr41/tr41-9.html#UAX29">UAX29</a>] <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="slc">Simple Lowercase Mapping</dt>
    <dd>Simple lowercase mapping (single character result). <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="stc">Simple Titlecase Mapping</dt>
    <dd>Simple titlecase mapping (single character result).
      <p><b>Note:</b> If this field is null, then the Simple_Titlecase_Mapping is the same as the Simple_Uppercase_Mapping for this character.</p> <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="suc">Simple Uppercase Mapping</dt>
    <dd>Simple uppercase mapping (single character result).<br>
      If a character is part of an alphabet with case distinctions, and has a simple uppercase equivalent, then the uppercase equivalent is in this field. The simple mappings have a single character result, where the full mappings may have multi-character results. For more information, see <a href="http://unicode.org/reports/tr44/#Casemapping">Case and Case Mapping</a>. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
    <dt id="SD">Soft Dotted</dt>
    <dd>Characters with a "soft dot", like <i>i</i> or <i>j</i>. An accent placed on these characters causes the dot to disappear. An explicit <i>dot above</i> can be added where required, such as in Lithuanian. <small><?=sprintf(__('(Source: %s)'), '<a href="http://unicode.org/reports/tr44/">UAX44</a>')?></small></dd>
